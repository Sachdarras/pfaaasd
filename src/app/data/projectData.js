const projects = [
  ...
  },
  {
    ...
    techno: [1, 2, 3, 4, 5, 7, 8, 11, 12, 14, 9]
  },
  {
    id: 4,
    name: "AgendStrauss",
    ...
    description:
      "L'agend strauss est un ensemble de fonctionnalités avec une todo-list, une calculatrice, un agenda et une horloge numérique.",
    lien: "https://agendstrauss.netlify.app/",
    repo: "https://github.com/Sachdarras/agendStrauss",
    techno: [1, 2, 3, 4, 5, 7, 8, 11, 12, 9]
  },
  {
    id: 5,
    ...
    description:
      "Échappée Célèbrement Fantasque est une plateforme en ligne unique qui propose aux utilisateurs de choisir des sujets thématiques et de les explorer en compagnie de célébrités ou de personnages fictifs...",
  ...
  },
  {
    ...
    description:
      "Origin Digital est une plateforme innovante dédiée au visionnage de vidéos...",
